...
func TestJetStreamCheckBytesLimitsOverflow(t *testing.T) {
	...
	js.mu.RLock()
	err := js.checkBytesLimits(limits, math.MaxInt64, FileStorage, 1, false, 0, 1)
	js.mu.RUnlock()
	require_Error(t, err)

	js.mu.RLock()
	err = js.checkBytesLimits(limits, math.MaxInt64, MemoryStorage, 1, false, 0, 1)
	js.mu.RUnlock()
	require_Error(t, err)
	...
	js.mu.RLock()
	err = js.checkBytesLimits(limits, 2, FileStorage, 1, true, 0, 0)
	js.mu.RUnlock()
	require_Error(t, err)
	...
	js.mu.RLock()
	err = js.checkBytesLimits(limits, 2, MemoryStorage, 1, true, 0, 0)
	js.mu.RUnlock()
	require_Error(t, err)
