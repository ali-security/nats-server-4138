...
const (
	...
	JSMirrorConsumerRequiresAckFCErr ErrorIdentifier = 10213
	...
	JSMirrorDurableConsumerCfgInvalid ErrorIdentifier = 10212
	...
	JSSourceConsumerRequiresAckFCErr ErrorIdentifier = 10216
	...
	JSSourceDurableConsumerCfgInvalid ErrorIdentifier = 10214

	// JSSourceDurableConsumerDuplicateDetected duplicate stream source consumer detected
	JSSourceDurableConsumerDuplicateDetected ErrorIdentifier = 10215
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSConsumerAckFCRequiresFCErr:                 {Code: 400, ErrCode: 10218, Description: "flow control ack policy requires flow control"},
		JSConsumerAckFCRequiresMaxAckPendingErr:      {Code: 400, ErrCode: 10219, Description: "flow control ack policy requires max ack pending"},
		JSConsumerAckFCRequiresNoAckWaitErr:          {Code: 400, ErrCode: 10220, Description: "flow control ack policy requires unset ack wait"},
		JSConsumerAckFCRequiresNoMaxDeliverErr:       {Code: 400, ErrCode: 10221, Description: "flow control ack policy requires unset max deliver"},
		JSConsumerAckFCRequiresPushErr:               {Code: 400, ErrCode: 10217, Description: "flow control ack policy requires a push based consumer"},
		...
		JSMirrorConsumerRequiresAckFCErr:             {Code: 400, ErrCode: 10213, Description: "stream mirror consumer requires flow control ack policy"},
		JSMirrorConsumerSetupFailedErrF:              {Code: 500, ErrCode: 10029, Description: "{err}"},
		JSMirrorDurableConsumerCfgInvalid:            {Code: 400, ErrCode: 10212, Description: "stream mirror consumer config is invalid"},
		...
		JSSourceConsumerRequiresAckFCErr:             {Code: 400, ErrCode: 10216, Description: "stream source consumer requires flow control ack policy"},
		...
		JSSourceDurableConsumerCfgInvalid:            {Code: 400, ErrCode: 10214, Description: "stream source consumer config is invalid"},
		JSSourceDurableConsumerDuplicateDetected:     {Code: 400, ErrCode: 10215, Description: "duplicate stream source consumer detected"},
